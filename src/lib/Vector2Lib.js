...
console.log("Loading vector2.js");

function Vector2( x, y ) {
    this.x = x || 0;
    this.y = y || 0;
    this.getWidth=function() { return this.x };
    this.setWidth=function( value ) { this.x = value };
    this.getHeight=function() { return this.y };
    this.setHeight=function( value ) { this.y = value };
