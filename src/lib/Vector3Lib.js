...
function Vector3( x, y, z ) {
    ...
    this.interpolate=function ( u , v , f ) {
	this.uf= 1-f;
    ...
    this.setSpherical= function ( r,lat,lon ) {
	this.r = r;
	this.lat = lat;
	this.lon = lon;
    };
    this.spherical2cartesian= function ( axis ) {
	if (axis !== undefined) {
    ...
    this.cartesian2rotated= function (axis) {
	if (axis !== undefined) {
    ...
    this.rotated2cartesian= function (axis) {
	if (axis !== undefined) {
    ...
    this.cartesian2Spherical= function (axis) {
	if (axis !== undefined) {
	    var xm = this.x*axis.i.x + this.y*axis.i.y + this.z*axis.i.z;
	    var ym = this.x*axis.j.x + this.y*axis.j.y + this.z*axis.j.z;
	    var zm = this.x*axis.k.x + this.y*axis.k.y + this.z*axis.k.z;
