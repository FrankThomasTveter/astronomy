...
export declare function maxValue<T>(array: Array<T>, callback: (item: T) => number): number;
export declare function minValue<T>(array: Array<T>, callback: (item: T) => number): number;
