...
import { Animation, CameraOptionsProp, Coordinates, FocusCallback, FocusOptionsProp, GlobeOptionsProp, LightOptionsProp, Marker, MarkerCallback, MarkerOptionsProp, Size } from './types';
...
declare function ReactGlobe({ animations, cameraOptions, focus, focusOptions, globeOptions, lightOptions, initialCoordinates, markers, markerOptions, onClickMarker, onDefocus, onMouseOutMarker, onMouseOverMarker, onGetGlobeInstance, onTextureLoaded, size: initialSize, }: Props): JSX.Element;
